...
load(
  "data_analysis/exposomeChemical_gut_microbiome/gut_microbiome_expression_data1"
)
...
load(
  "data_analysis/exposomeBiological_gutmicrobiome/exposomeBiological_expression_data1"
)
exposomeBiological_expression_data <-
  exposomeBiological_expression_data1
load(
  "data_analysis/exposomeBiological_gutmicrobiome/exposomeBiological_sample_info"
)
exposomeBiological_sample_info <- exposomeBiological_sample_info

load(
  "data_analysis/exposomeBiological_gutmicrobiome/gutmicrobiome_expression_data1"
)
