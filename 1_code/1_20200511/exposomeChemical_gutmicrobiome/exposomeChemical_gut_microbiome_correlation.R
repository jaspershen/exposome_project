...
setwd("3_data_analysis/exposomeChemical_gut_microbiome/")
...
colnames(gut_microbiome_expression_data) <-
  as.character(gut_microbiome_sample_info$CollectionDate)
...
gut_microbiome_expression_data1 <-
  purrr::map(
    as.data.frame(t(gut_microbiome_expression_data)),
    .f = function(x) {
      temp_data <-
...
setwd(r4projects::get_project_wd())
setwd(
  "3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/exposomeChemical_gut_microbiome_plot"
)
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/")
