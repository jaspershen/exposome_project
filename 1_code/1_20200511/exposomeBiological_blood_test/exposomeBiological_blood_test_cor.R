...
setwd("3_data_analysis/data_20200511/exposomeBiological_blood_test/")
...
colnames(exposomeBiological_expression_data) <- colnames(blood_test_expression_data)
...
ggsave(plot, filename = "blood_test_plot/blood_test_heatmap.pdf", width = 7, height = 7)
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/exposomeBiological_blood_test/exposomeBiological_blood_test_plot")
for(idx in 1:20){
  cat(idx, " ")
...
ggsave(
  plot1,
  filename = "exposomeBiological_blood_test_correlation_network.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent"
)
...
ggsave(
  plot1,
  filename = "exposomeBiological_blood_test_correlation_network.png",
  width = 8.5,
  height = 7,
  bg = "transparent"
)
