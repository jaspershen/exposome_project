...
load("3_data_analysis/data_20200511/exposomeChemical_metabolome/annotation_result")
load("3_data_analysis/data_20200511/exposomeChemical_metabolome/kegg.compound.rda")
kegg.compound <- 
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/exposome_metabolome_correlation_network/")
