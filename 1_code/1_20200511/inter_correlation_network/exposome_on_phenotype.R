...
##exposomeBiological
###exposome biological
load("3_data_analysis/data_20200511/microbiome/dna_expression_data")
exposomeBiological_expression_data <- dna_expression_data
load("3_data_analysis/data_20200511/microbiome/dna_sample_info")
exposomeBiological_sample_info <- dna_sample_info
load("3_data_analysis/data_20200511/microbiome/dna_variable_info")
exposomeBiological_variable_info <- dna_variable_info

###environment
load("3_data_analysis/data_20200511/environment/expression_data")
environment_expression_data <- expression_data
load("3_data_analysis/data_20200511/environment/sample_info")
environment_sample_info <- sample_info
load("3_data_analysis/data_20200511/environment/variable_info")
environment_variable_info <- variable_info

####load blood_test data
load("3_data_analysis/data_20200511/lab_test/expression_data")
blood_test_expression_data <- expression_data
load("3_data_analysis/data_20200511/lab_test/sample_info")
blood_test_sample_info <- sample_info
load("3_data_analysis/data_20200511/lab_test/variable_info")
blood_test_variable_info <- variable_info

##cytokine
load("3_data_analysis/data_20200511/cytokine/expression_data")
cytokine_expression_data <- expression_data
load("3_data_analysis/data_20200511/cytokine/sample_info")
cytokine_sample_info <- sample_info
load("3_data_analysis/data_20200511/cytokine/variable_info")
cytokine_variable_info <- variable_info

###
setwd("3_data_analysis/data_20200511/exposome_blood_test_cytokine")
...
load("3_data_analysis/data_20200511/exposomeChemical_cytokine/cor_value")
exposomeChemical_cytokine_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)
dim(exposomeChemical_cytokine_cor)

load("3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/cor_value")
...
load("3_data_analysis/data_20200511/exposomeChemical_metabolome/cor_value")
...
load("3_data_analysis/data_20200511/exposomeChemical_proteome/cor_value")
...
#####exposomeBiological
load("3_data_analysis/data_20200511/exposomeBiological_blood_test/cor_value")
exposomeBiological_blood_test_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05) %>%
  dplyr::mutate(from = paste("exposome", from, sep = "_"))

load("3_data_analysis/data_20200511/exposomeBiological_cytokine/cor_value")
exposomeBiological_cytokine_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05) %>%
  dplyr::mutate(from = paste("exposome", from, sep = "_"))

load("3_data_analysis/data_20200511/exposomeBiological_gutmicrobiome/cor_value")
exposomeBiological_gut_microbiome_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05) %>%
  dplyr::mutate(from = paste("exposome", from, sep = "_"))

load("3_data_analysis/data_20200511/exposomeBiological_metabolome/cor_value")
exposomeBiological_metabolome_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05) %>%
  dplyr::mutate(from = paste("exposome", from, sep = "_"))

load("3_data_analysis/data_20200511/exposomeBiological_proteome/cor_value")
...
#####environment
load("3_data_analysis/data_20200511/environment_blood_test/cor_value")
environment_blood_test_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)

load("3_data_analysis/data_20200511/environment_cytokine/cor_value")
environment_cytokine_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)

load("3_data_analysis/data_20200511/environment_gutmicrobiome/cor_value")
environment_gut_microbiome_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)

load("3_data_analysis/data_20200511/environment_metabolome/cor_value")
...
load("3_data_analysis/data_20200511/environment_proteome/cor_value")
...
load("3_data_analysis/data_20200511/proteome/variable_info")
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/inter_omics_correlation_network/")
