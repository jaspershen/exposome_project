...
load("3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/exp_expression_data1")
exposomeChemical_expression_data <- exp_expression_data1
load("3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/exp_sample_info")
exposomeChemical_sample_info <- exp_sample_info

load(
  "3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/gut_microbiome_expression_data1"
)
gut_microbiome_expression_data1 <- gut_microbiome_expression_data1
load("3_data_analysis/data_20200511/exposomeChemical_gut_microbiome/gut_microbiome_sample_info")
...
load(
  "3_data_analysis/data_20200511/exposomeBiological_gutmicrobiome/exposomeBiological_expression_data1"
)
exposomeBiological_expression_data <-
  exposomeBiological_expression_data1
load(
  "3_data_analysis/data_20200511/exposomeBiological_gutmicrobiome/exposomeBiological_sample_info"
)
exposomeBiological_sample_info <- exposomeBiological_sample_info

load(
  "3_data_analysis/data_20200511/exposomeBiological_gutmicrobiome/gutmicrobiome_expression_data1"
)
gut_microbiome_expression_data2 <- gutmicrobiome_expression_data1
load("3_data_analysis/data_20200511/exposomeBiological_gutmicrobiome/gutmicrobiome_sample_info")
...
cor_value <-
  rbind(exposomeChemical_gut_microbiome_cor,
        exposomeBiological_gut_microbiome_cor)
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/exposome_gut_microbiome_correlation_network/")
...
node_data1 =
  node_data1 %>%
  dplyr::filter((Class != "Gut microbiome") | (Class == "Gut microbiome" &
                                                 Degree > 20))
