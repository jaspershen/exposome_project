...
###
setwd("3_data_analysis/data_20200511/exposome_blood_test")
...
blood_test_range <-
  readxl::read_xlsx("3_data_analysis/data_20200511/lab_test_analysis/data_overview/Blood range.xlsx")
