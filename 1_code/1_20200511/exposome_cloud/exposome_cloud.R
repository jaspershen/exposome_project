...
load("3_data_analysis/data_20200511/exposomeChemical_environment/temp")
load("3_data_analysis/data_20200511/exposomeChemical_environment/diff")
temp1 = temp
diff1 = diff

load("3_data_analysis/data_20200511/exposomeBiological_environment/temp")
load("3_data_analysis/data_20200511/exposomeBiological_environment/diff")
temp2 = temp
diff2 = diff

load("3_data_analysis/data_20200511/exposomeChemical_exposomeBiological/temp")
load("3_data_analysis/data_20200511/exposomeChemical_exposomeBiological/diff")
temp3 = temp
diff3 = diff

load("3_data_analysis/data_20200511/exposomeChemical_environment/cor_value")
exposomeChemical_environment_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)

load("3_data_analysis/data_20200511/exposomeBiological_environment/cor_value")
exposomeBiological_environment_cor <-
  cor_value %>%
  dplyr::filter(abs(cor) > 0.9 & p_value < 0.05)

load("3_data_analysis/data_20200511/exposomeChemical_exposomeBiological/cor_value")
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/data_20200511/exposome_cloud/")
